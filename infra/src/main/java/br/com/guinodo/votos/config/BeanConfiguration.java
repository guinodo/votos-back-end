...
//    }
    ...
    public VotarUseCase votarUseCase(
        ...
        return new VotarUseCase(votoRepository, cpfRepository, sessaoVotacaoRepository, associadoRepository, cpfService);
    }
    ...
    @Bean
    public IniciarSessaoVotacaoUseCase iniciarSessaoVotacaoUseCase (
            SessaoVotacaoRepository sessaoVotacaoRepository,
            PautaRepository pautaRepository) {
        return new IniciarSessaoVotacaoUseCase(sessaoVotacaoRepository, pautaRepository);
    }
